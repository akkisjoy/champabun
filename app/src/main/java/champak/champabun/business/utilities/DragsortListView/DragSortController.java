...
public class DragSortController extends SimpleFloatViewManager implements View.OnTouchListener, GestureDetector.OnGestureListener {
    ...
    private GestureDetector.OnGestureListener mFlingRemoveListener =
            new GestureDetector.SimpleOnGestureListener() {
                ...
                public final boolean onFling(MotionEvent e1, MotionEvent e2, float velocityX,
                                             float velocityY) {
                    // Logger.d("mobeta", "on fling remove called");
                    if (mRemoveEnabled && mIsRemoving) {
                        int w = mDslv.getWidth();
                        int minPos = w / 5;
                        if (velocityX > mFlingSpeed & velocityY < 7) {
                            if (mPositionX > -minPos) {
                                mDslv.stopDragWithVelocity(true, velocityX);
                            }
                        } else if (velocityX < -mFlingSpeed & velocityY > -7) {
                            if (mPositionX < minPos) {
                                mDslv.stopDragWithVelocity(true, velocityX);
                            }
                        }
    ...
    public int viewIdHitPosition(MotionEvent ev, int id) {
        ...
        // Logger.d("mobeta", "touch down on position " + itemnum);
    ...
    public void onLongPress(MotionEvent e) {
        // Logger.d("mobeta", "lift listener long pressed");
