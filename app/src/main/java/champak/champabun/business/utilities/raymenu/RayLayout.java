...
public class RayLayout extends ViewGroup {
        ...
        if (attrs != null) {
            ...
            switch (screenSize) {
                case Configuration.SCREENLAYOUT_SIZE_LARGE:
                    mChildSize = (int) ((int) (40 * getResources().getDisplayMetrics().density) + 0.5);

                    break;
                case Configuration.SCREENLAYOUT_SIZE_NORMAL:
                    mChildSize = (int) ((int) (30 * getResources().getDisplayMetrics().density) + 0.5);
    ...
    private void bindChildAnimation(final View child, final int index, final long duration) {
        ...
        AnimationSet animationexp = new AnimationSet(false); //change to false
        animationexp.addAnimation(fadeIn);
        animationexp.addAnimation(createExpandAnimation(0, toXDelta, 0, toYDelta, startOffset, duration, interpolator));
        ...
        AnimationSet animationshr = new AnimationSet(false); //change to false
        animationshr.addAnimation(fadeOut);
        animationshr.addAnimation(createShrinkAnimation(0, toXDelta, 0, toYDelta, startOffset, duration,
                interpolator));


        Animation animation = mExpanded ? fadeOut : animationexp;
