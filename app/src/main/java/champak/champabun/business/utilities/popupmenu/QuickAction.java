package champak.champabun.business.utilities.popupMenu;
...
public class QuickAction extends PopupWindows implements OnDismissListener {
    ...
    public QuickAction(Context context) {
        ...
        mTrackAnim.setInterpolator(new Interpolator() {
            public float getInterpolation(float t) {
                ...
                final float inner = (t * 1.5f) - 1.1f;

                return 1.24f - inner * inner;
            }
        });
    ...
    public void addActionItem(ActionItem action) {
        ...
        if (icon != null) {
            ...
            //img.requestLayout() ;
            //img.getLayoutParams().height=49;
            //img.getLayoutParams().width=49;
        } else {
    ...
    public void removeActionItem(int x)

    {
        if (mChildPos >= x) {
            mTrack.removeViewAt(x);
            mChildPos--;
        }
    ...
    public void show(View anchor) {
        ...
        int yPos = mWindowManager.getDefaultDisplay().getHeight();
        boolean onTop = true;
