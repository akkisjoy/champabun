    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mListView.setOnItemClickListener(new OnItemClickListener() {
            public void onItemClick(AdapterView<?> a, View v, int position, long id) {
                ...
                if (songs.size() > 800) {
                    GlobalSongList.GetInstance().SetNowPlayingList(songs);
                } else {
                    GlobalSongList.GetInstance().SetNowPlayingList(new ArrayList<SongDetails>(songs));
                }
                    ...
                    dlgLV.setOnItemClickListener(new OnItemClickListener() {
                        ...
                        public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                            if (position == 0) {
                                ...
                                ActivityUtil.showCrouton((Activity) Album.this, ss);
                            } else if (position == 1) {
                                create_new_playlist();
                            } else {
                                // id of the playlist
        ...
        bDOK.setOnClickListener(new OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if (save.getText().toString() != null) {
                    int YOUR_PLAYLIST_ID = Now_Playing.createPlaylist(save.getText().toString(), Album.this);
    ...
    class AddToPlayListMultiple extends AsyncTask<Void, String, String> {
        ...
        protected String doInBackground(Void... params) {
            for (int i = 0; i < multiplecheckedListforaddtoplaylist.size(); i++)
                Now_Playing.addToPlaylist(Album.this.getApplicationContext(), multiplecheckedListforaddtoplaylist.get(i).getPath2(), playlistid);
