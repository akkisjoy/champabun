...
import champak.champabun.classes.PresetValue;
import champak.champabun.equalizer.EqualizerValue;
...
public class PlayMeePreferences {
    ...
    public int GetRepeatMode() {
        SharedPreferences prefs = context.getSharedPreferences(filename, Context.MODE_PRIVATE);
        return prefs.getInt(key_player_repeat_mode, GlobalSongList.REPEAT_NONE);
    }
