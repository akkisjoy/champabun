 ...
 */
public class DownloadProVersion {

    private static final String TAG = DownloadProVersion.class.getSimpleName();

    private static final String PREF_NAME = "DownloadProVersion";
    ...
    public static void showRateDialog(final Context context) {
        ...
        builder.setTitle(R.string.downloadPro_dialog_title);
        builder.setMessage(R.string.downloadPro_dialog_message);
        builder.setPositiveButton(R.string.downloadPro_dialog_ok, new OnClickListener() {
            @Override
        ...
        builder.setNeutralButton(R.string.downloadPro_dialog_cancel, new OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                clearSharedPreferences(context);
            }
        });
        builder.setNegativeButton(R.string.downloadPro_dialog_no, new OnClickListener() {
            @Override
            public void onClick(DialogInterface dialog, int which) {
                setOptOut(context, true);
            }
