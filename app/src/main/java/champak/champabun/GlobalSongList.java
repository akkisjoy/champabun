...
import champak.champabun.classes.PlayMeeConfig;
import champak.champabun.classes.SongDetails;
import champak.champabun.util.AppConfigHelper;
...
//	public static int  splashscreenopen=1;
    ...
    public String path;
    private static GlobalSongList mInstance;
    ...
    public static GlobalSongList GetInstance() {
        return mInstance;
    }
